...
const Login = () => {
  ...
  const handleLogin = () => {
    ...
    // setOTPSect(true);
    if (loginEmail === "") {
      setInputError("email in required");
      ...
      fetch(`${import.meta.env.VITE_BASE_URL}api/login`, requestOptions)
        ...
        <div className="mt-12 flex flex-col items-center default_animate">
          ...
          <div className="w-full flex-1 mt-8">
            ...
            <div className="mx-auto max-w-xs">
              ...
              >
                <p className="text-center mt-3">Don't have account? Sign Up</p>
              </Link>
        ...
        <div className="mt-12 flex flex-col items-center default_animate">
          ...
          <div className="w-full flex-1 mt-8">
            ...
            <span className="text-gray-400 m-2 text-xs font-semibold">
              To continue, enter the verification code sent to: {loginEmail}
            </span>
            {InputError && (
              <p className="text-xs text-red-500 font-semibold m-2 default_animate">
                {InputError}
