    ...
    <div>
      ...
      <Container>
        ...
        <div className="flex flex-col lg:flex-row gap-2 mt-5">
          ...
          {/* Second Section */}
          <div className="w-full lg:w-[33%] border-l p-4">
            <div className="flex flex-col gap-5">
              ...
              <div className="bg-[#19467E]">
                ...
                <div className="bg-slate-100 p-2 space-y-3">
                  <h1 className="text-sm">
                    Articles Viewed :{" "}
                    <span className="font-semibold">4317</span>
                  </h1>
                  <h1 className="text-sm">
                    Articles Downloaded :{" "}
                    <span className="font-semibold">4317</span>
              ...
              <div className="bg-[#19467E]">
                ...
                <div className="bg-slate-100 p-2 space-y-3 flex flex-col">
                  <Link to="" className="text-sm underline text-blue-500">January 2025</Link>
                  <Link to="" className="text-sm underline text-blue-500">Previous</Link>
                </div>
              </div>
            </div>
          </div>
